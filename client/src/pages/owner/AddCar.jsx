        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-white text-sm mt-6 max-w-xl'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
               <div className='flex flex-col w-full'>
                <label>Brand</label>
                <input type="text" placeholder='e.g. Tata, Mercedes, Honda...' required 
            ...
            <button className='flex items-center gap-2 px-4 py-2.5 mt-4 bg-[var(--color-primary)] text-white rounded-md font-medium w-max cursor-pointer'>
