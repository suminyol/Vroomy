                    ...
                    <tr key={index} className='border-t border-[var(--color-borderColor)] text-gray-500 '>
                        ...
                        <td className='p-3'>
                            {booking.status === 'pending' ? (
                                <select value={booking.status} className='px-2 py-1.5 mt-1 text-gray-500 border border-[var(--color-borderColor)]
                                ...
                                <span className={`px-3 py-1 rounded-full text-xs fonr-semibold ${booking.status === 'confirmed'
