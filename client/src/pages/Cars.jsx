    ...
    return (
        <div>
            <div className='flex flex-col items-center py-20 bg-light max-md:px-4'>
                            <Title title='Availabl e Cars' subTit1e='Browse our selection of premium
                            ...
                            <input onClick={(e)=>setInput(e.target.value)} value={input} type='text' placeholder='Search by make,model, or features' className='w-full h-full outline-none text-gray-500'></input>
                        ...
                        <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-10'>
                            ...
                            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4
                                    ...
                                    {dummyCarData.map((car,index)=>(<div key={index}>
                                    <CarCard car={car}/> </div>))}
                                </div>
                        </div>
        </div>
