...
function Newsletter(props) {
    return (
        ...
        className="flex flex-col items-center justify-center text-center space-y-2 max-md:px-4 my-10 mb-40">
            ...
            whileInView={{opacity:1,y:0}}
            transition={{delay:0.3,duration:0.5}} className="md:text-lg text-white/90 pb-8">
            ...
            className="flex items-center justify-between max-w-2xl w-full md:h-13 h-12">
                <input
                    className="border border-white rounded-md h-full border-r-0 outline-none w-full rounded-r-none px-3 text-white"
                    type="text"
